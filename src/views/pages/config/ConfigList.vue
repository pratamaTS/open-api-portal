...
const fetchData = async (page = 1, searchQuery = '') => {
  try {
    let url = `https://gateway.berkompeten.com/api/admin/master/config?page=${page}`;
    if (searchQuery) {
...
//   try {
//     const response = await axios.delete(`https://gateway.berkompeten.com/api/admin/master/category-lab?id=${id}`, {
//       headers: {
//         Authorization: `Bearer ${token}`,
//       },
//     });
